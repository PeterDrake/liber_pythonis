...
![standard deviation of 1, 4, 8](https://latex.codecogs.com/svg.latex?\sqrt{\frac{(1-\tfrac{11}{3})^2&space;&plus;&space;(4-\tfrac{11}{3})^2&space;&plus;&space;(8-\tfrac{11}{3})^2}{3}}&space;\approx&space;2.9)
